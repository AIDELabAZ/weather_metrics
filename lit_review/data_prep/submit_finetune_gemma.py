...
TRAIN_PATH = f"gs://{GCS_BUCKET}/training_gemma.jsonl"
VALIDATION_PATH = f"gs://{GCS_BUCKET}/validation_gemma.jsonl"

# Confirm the exact tuning-eligible Model Garden ID in the Vertex AI console
# (Tune and distill > Gemma) before running — availability varies by project/region.
...
def main():
    ...
    print("Once complete, copy the deployed endpoint/tuned model name into "
          "extraction/fine_tuned/finetune_gemma.py (ENDPOINT_ID / GCP_PROJECT / GCP_LOCATION).")
