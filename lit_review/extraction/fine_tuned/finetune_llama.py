...
def get_endpoint():
    ...
    Confirm the exact request schema for your deployed Llama container in the
    Vertex AI console (Endpoints > your endpoint > Sample request) — Model Garden
    Llama deployments commonly expose an OpenAI-compatible chat schema; adjust
...
def build_text_input(doc_context, prior_qa_pairs, current_key, current_question):
    """
    Assemble the full prompt for one question, identical to conversion_code_llama.py.
